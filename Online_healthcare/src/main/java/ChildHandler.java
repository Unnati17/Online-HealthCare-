...
/**
 * Servlet implementation class ChildHandler
 */
public class ChildHandler extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html; charset=UTF-8");
	      ...
	      try {
	         ...
	         out.println("<h2>Hostipal : Medanta Hospital</h2>");
	         out.println("<h3>Doctor's Name : Dr. Ranjit</h3>");
	         
	         String specialist="Dr. Ranjit";
